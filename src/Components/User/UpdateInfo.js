...
class UpdateInfo extends Component {
    ...
    handleUpdate() {
        ...
        if (sessionStorage.getItem("role") === "INSTITUTION") { //verificar o role aqui!!!
            url += ServicePathsLabel.Institution + "/" + sessionStorage.getItem('id') + PathsLabel.UpdateInfo + '?tokenId=' + sessionStorage.getItem('token');
        ...
        if(sessionStorage.getItem("role") === "USER"){
            url += ServicePathsLabel.User + "/" + sessionStorage.getItem('id') + PathsLabel.UpdateInfo + '?tokenId=' + sessionStorage.getItem('token');
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="formAddr">
                                ...
                                <Form.Control name="addr1" placeholder="Introduz a morada"
                                    onChange={this.onChange} value={this.state.addr} />
                            </Form.Group>
                            ...
                            <Form.Group controlId="formZip">
                                ...
                                <Form.Control name="zip" placeholder="Introduz o código postal"
